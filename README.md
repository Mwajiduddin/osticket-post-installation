...
In the next tutorial we will be playing around wtih osTicket and show how to create a ticket, change its configurations and resolve one so don't tear down you virtual machine just.
